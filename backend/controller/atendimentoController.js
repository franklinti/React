...
rota.get("/",function(req,res,next){
   AtendimentoModel.getAtendimento(function(erro,retorno){
...
rota.get("/:cpf?",function(req,res,next){
  AtendimentoModel.getAtendimentoId(req.params.cpf,function(erro,retorno){
    let mensagemEvento = new MensagemEvento();
    if(erro){
      mensagemEvento = true;
      mensagemEvento.mensagem="Erro ao recuperar dados banco";
...
rota.post("/?",function(req,res,next){
  AtendimentoModel.adicionar(req.body,function(erro,retorno){
    let mensagemEvento = new MensagemEvento();
    if(erro){
      mensagemEvento = true;
      mensagemEvento.mensagem="Erro ao recuperar dados banco";
...
rota.delete("/:cpf",function(req,res,next){
  AtendimentoModel.deletar(req.params.cpf,function(erro,retorno){
    let mensagemEvento = new MensagemEvento();
    if(erro){
      mensagemEvento = true;
      mensagemEvento.mensagem="Erro ao recuperar dados banco";
...
rota.put("/",function(req,res,next){
  AtendimentoModel.editar(req.body,function(erro,retorno){
    let mensagemEvento = new MensagemEvento();
    if(erro){
      mensagemEvento = true;
      mensagemEvento.mensagem="Erro ao recuperar dados banco";
